      ...
      <article class="prose lg:prose-lg lg:min-w-3/4">
        ...
        <CollapseH2 title="Basic Concepts">
          ...
          <CollapseH3 title="Numbers">
            ...
            <p>The numbers 12^6 to 12^39 are, in 12^3 (3-digit group) distance, formed by taking the onset of the digit (tj- in case of tensja, otherwise it would be identical to teira) and appending the suffix <q>-uina</q>. 12^39 though is <span class="bg-green-100">rieina</span>, after which 12^42 is <span class="bg-green-100">riefluina</span>. No one wants to continue this pattern beyond its current definition.</p>
